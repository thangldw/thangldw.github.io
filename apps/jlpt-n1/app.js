(function () {
  ...
  function renderQuizQuestion() {
    ...
    appView.innerHTML = '<section class="view quiz-view"><div class="quiz-topline"><button type="button" data-action="quit-quiz">← Thoát lượt</button><span class="quiz-status"><span>Câu ' + (quizSession.index + 1) + ' / ' + quizSession.questions.length + '</span><strong>Đúng ' + quizSession.score + ' / ' + quizSession.questions.length + '</strong></span><strong id="quizTimer">' + quizSession.seconds + 's</strong></div><div class="quiz-timer-track"><span id="quizTimerFill" style="width:' + (quizSession.seconds / 30 * 100) + '%"></span></div>' +
